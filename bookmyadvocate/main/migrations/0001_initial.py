# Generated by Django 4.2 on 2025-11-14 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('advocate', 'Advocate')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advocate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='advocate_bookings', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='AdvocateRegistrationPayment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
